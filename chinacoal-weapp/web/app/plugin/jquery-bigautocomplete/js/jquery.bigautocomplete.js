	...
	var bigAutocomplete = new function(){
		...
		this.init = function($this){
			...
			$(document).bind('mousedown',function(event){
				...
				if((!($target.parents().andSelf().is('#bigAutocompleteContent'))) && (!$target.is($(currentInputText)))){
					bigAutocomplete.hideAutocomplete($this);
				}
			})
		...
		this.autocomplete = function(param){
			...
			$this.keyup(function(event) {
				var cascadehidden = document.getElementById($this.attr("data-cascadeid"));
				if(cascadehidden){
					cascadehidden.value = "";
				}
				var k = event.keyCode;
		...
		this.hideAutocomplete = function($this){
			// var cascadehidden = document.getElementById($this.attr("data-cascadeid"));
			// if(cascadehidden && cascadehidden.value == ""){
			// 	$this.val("");
			// }
		...
		this.clearValueIfNotSelect = function(){
			$("input[data-cascadeid]").each(function(i){
				var cascadehidden = document.getElementById($(this).attr("data-cascadeid"));
				if(cascadehidden && cascadehidden.value == ""){
					$(this).val("");
				}
