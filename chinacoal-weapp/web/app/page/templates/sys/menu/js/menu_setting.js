define(['jquery','widget/dialog','widget/ajax_form','widget/http',
    '../../service', 'service/util_service', 'route_config','bootbox','zTree'],
    function($,dialog, ajax_form,http,service, util_service, route_config,bootbox,zTree)  {
	var page = {
        ...
        bindEvent:function() {
            ...
            $("#toolbar").on('click','#menu_refresh',$.proxy(this.refresh, this));
        },
         ...
         addClick:function(event) {
             let $this = $(event.target),
                ...
                dialog.page({
                    title: '菜单新增',
                    stateParams: { pageType: 'addMenuTree', id: id}, //传输给新页面的数据；pageType比传；update,add,view
        ...
        */
        ...
        zTreeOnClick:function(event, treeId, treeNode) {
            ...
            dialog.page({
                title: '编辑节点',
                stateParams: { pageType: 'edit', id: treeNode.id,pId:treeNode.pId}, //传输给新页面的数据；pageType比传；update,add,view
                loadUrl: '/sys/menu/edit'
            });
        },
